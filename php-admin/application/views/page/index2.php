					...
					<div class="row align-items-center">
						<div class="col-sm-6">
							<div class="breadcrumbs-area clearfix">
								<h4 class="page-title pull-left">Dashboard 2</h4>
								<ul class="breadcrumbs pull-left">
									<li><a href="<?= site_url("home/dashboard") ?>">Home</a></li>
									<li><span>Dashboard 2</span></li>
								</ul>
							</div>
						</div>
					</div>
                                ...
                                <div class="member-box">
                                    <div class="s-member">
                                        <div class="media align-items-center">
                                            <img src="<?= base_url("assets/images") ?>/team/team-author1.jpg" class="d-block ui-w-30 rounded-circle" alt="">
                                    ...
                                    <div class="s-member">
                                        <div class="media align-items-center">
                                            <img src="<?= base_url("assets/images") ?>/team/team-author2.jpg" class="d-block ui-w-30 rounded-circle" alt="">
                                            <div class="media-body ml-5">
                                    ...
                                    <div class="s-member">
                                        <div class="media align-items-center">
                                            <img src="<?= base_url("assets/images") ?>/team/team-author3.jpg" class="d-block ui-w-30 rounded-circle" alt="">
                                            <div class="media-body ml-5">
                                    ...
                                    <div class="s-member">
                                        <div class="media align-items-center">
                                            <img src="<?= base_url("assets/images") ?>/team/team-author4.jpg" class="d-block ui-w-30 rounded-circle" alt="">
                                            <div class="media-body ml-5">
                                    ...
                                    <div class="s-member">
                                        <div class="media align-items-center">
                                            <img src="<?= base_url("assets/images") ?>/team/team-author5.jpg" class="d-block ui-w-30 rounded-circle" alt="">
                                            <div class="media-body ml-5">
