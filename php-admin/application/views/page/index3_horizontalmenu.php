        ...
        <div class="mainheader-area">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <div class="logo">
                            <a href="index.html"><img src="<?= base_url("assets/images") ?>/icon/logo2.png" alt="logo" class="logo-horizontal"></a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9 clearfix text-right">
                        ...
                        <div class="clearfix d-md-inline-block d-block">
                            <div class="user-profile m-0">
                                <img class="avatar user-thumb dropdown-toggle img-rounded" data-toggle="dropdown" src="<?= base_url("assets/images") ?>/profile/john_doe.jpg" alt="avatar">
                                <div class="dropdown-menu p-10">
									<div class="profile-name text-center color-black">John Doe</div>
									<div class="profile-title text-center color-black">Administrator</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <nav>
                                <ul id="nav_menu">
                                    <li>
                                        ...
                                        <ul class="submenu">
                                            <li><a href="<?= site_url("home/dashboard") ?>">Dashboard 1</a></li>
                                            <li><a href="<?= site_url("home/dashboard2") ?>">Dashboard 2</a></li>
                                            <li><a href="<?= site_url("home/dashboard3") ?>">Dashboard 3</a></li>
                                        </ul>
                                    </li>
                                    <li>
                        ...
                        <div class="card">
                            <div class="card-body bg1">
                                ...
                                <div class="testimonial-carousel owl-carousel">
                                    <div class="tst-item">
                                        <div class="tstu-img">
                                            <img src="<?= base_url("assets/images") ?>/team/team-author1.jpg" alt="author image">
                                        </div>
                                    ...
                                    <div class="tst-item">
                                        <div class="tstu-img">
                                            <img src="<?= base_url("assets/images") ?>/team/team-author2.jpg" alt="author image">
                                        </div>
                                        <div class="tstu-content">
                                            <h4 class="tstu-name">Abel Franecki</h4>
                                            <span class="profsn">Designer</span>
                                    ...
                                    <div class="tst-item">
                                        <div class="tstu-img">
                                            <img src="<?= base_url("assets/images") ?>/team/team-author3.jpg" alt="author image">
                                        </div>
                                        <div class="tstu-content">
                                            <h4 class="tstu-name">Abel Franecki</h4>
                                            <span class="profsn">Designer</span>
