    ...
    <div class="main-menu">
        <div class="menu-inner">
			<div class="sidebar-header">
				<div class="logo">
					<a href="<?= site_url("home/dashboard") ?>"><img src="<?= base_url("assets/images") ?>/icon/logo.png" class="img-logo" alt="logo"></a>
				</div>
				<div class="logo">
					<img src="<?= base_url("assets/images") ?>/profile/john_doe.jpg" class="img-profile img-rounded" alt="logo">
				</div>
				<div class="profile">
